        ...
        <>
            <div className='w-screen flex flex-col justify-center items-center'>
                ...
                <div className='self-image w-[95vw] h-[90vh] relative rounded-[50px] my-12 overflow-hidden'>
                    ...
                    <div className='name text-[12vw] absolute bottom-0 right-0 p-2 leading-45 text-[#ECDCC3] z-20'>SHINJAN</div>
                </div>

                <div className='w-[95vw] border-1 my-30'></div>

                <div className='desc text-[2vw] leading-10 flex justify-center items-center gap-10 p-8 mb-10 w-[95vw]'>
                    ...
                    <div className='flex flex-2/3 flex-col justify-center items-center gap-10'>
                        ...
                        <p className='desc-text1 text-justify text-wrap w-full0'>
                        ...
                        <p className='desc-text2 text-justify text-wrap'>Outside the studio, I enjoy visiting galleries, studying artistic movements, and experimenting with new materials to bring fresh perspectives into my art. For me, creativity is both expression and discovery, a way to capture what words often cannot.</p>
                    </div>
                </div>
